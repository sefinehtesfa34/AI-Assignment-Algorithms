...
for start_node in all_nodes:
    ...
    for target_node in all_nodes:
        ...
        start=start_node
        target=target_node
        path_tracker=dfsFunction(start,target)
        solution_len+=length
        print(start,target)
        temp=target
        shortest_path=[]          
...
print("The average solution length for DFS alogrithm: {} ".format(average_solution_length))
print("The average time taken for DFS algorithm: {}".format(average_time_taken))
